...
class ExportService extends GenericService
{
    ...
    {
        $filename = $_SERVER['DOCUMENT_ROOT'] . "/ExportService/" . date("Y-m-d-H-i") . ".sql";
        ...
        switch ($worked) {
            ...
            case 0:
                if (file_exists($filename)) {
                    ...
                    header('Content-Disposition: attachment; filename=' . APPLICATION_TITLE . '-database-ExportService-' . basename($filename));
                    header('Expires: 0');
