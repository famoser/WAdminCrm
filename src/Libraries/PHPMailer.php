...
class PhpMailerHook
{
    static function SendEmailFromServer($emails, $names, $subject, $message, $attachments = null, $additionalRecievers = null)
    {
        $SendFromEmail = SERVER_EMAIL;
        $SendFromEmailPassword = SERVER_EMAIL_PASSWORD;
        ...
        $mail->Password = $SendFromEmailPassword;
