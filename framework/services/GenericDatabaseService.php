...
class GenericDatabaseService extends GenericService
{
    ...
    {
        return $this->GetSingleByCondition($table, array("Id" => $id), $addRealtionships);
    }

    function GetAllOrderedBy($table, $orderBy, $addRealtionships = true, $additionalSql = null)
    {
        return $this->GetAllByCondition($table, null, $addRealtionships, $orderBy, $additionalSql);
    }
    ...
    function GetSingleByCondition($table, $condition, $addRealtionships = true, $orderBy = null)
    {
        if ($orderBy != null)
            $orderBy = " ORDER BY " . $orderBy;
